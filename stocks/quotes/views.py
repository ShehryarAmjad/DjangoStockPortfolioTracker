...
def home(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + ticker + "/quote?token=pk_365ff385aea548eaa92a54d39fd5a71b")
		try:
...
def add_stock(request):
	...
	if request.method == 'POST':
		...
		for ticker_item in ticker:		
			api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + str(ticker_item) + "/quote?token=pk_365ff385aea548eaa92a54d39fd5a71b")
